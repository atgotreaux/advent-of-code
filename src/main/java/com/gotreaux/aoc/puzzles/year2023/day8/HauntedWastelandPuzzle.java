...
public class HauntedWastelandPuzzle extends Puzzle {
    ...
    public HauntedWastelandPuzzle(InputProvider inputProvider) throws Exception {
        super(inputProvider);
    ...
    private long getStepsForNodes(Predicate<Node> startPosition, Predicate<Node> endPosition)
